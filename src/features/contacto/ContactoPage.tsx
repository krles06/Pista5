        ...
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="text-center space-y-2">
                    <h1 className="text-4xl font-black tracking-tighter text-foreground italic">CONTACTO</h1>
                    <p className="text-muted-foreground font-medium">
                        ¿Tienes alguna duda o sugerencia? Estamos aquí para ayudarte.
                    </p>
                </div>

                <Card className="border-border bg-card shadow-2xl rounded-3xl overflow-hidden">
